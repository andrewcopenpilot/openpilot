...
const Msg msgs[] = {
  ...
  {
    .name = "PTInterceptorASCMLKASteeringCmd",
    .address = 0x17F,
    .size = 4,
    .num_sigs = ARRAYSIZE(sigs_383),
    .sigs = sigs_383,
  },
  {
  ...
  {
    .name = "PTInterceptorActiveCruiseControlStatus",
    .address = 0x36F,
    .size = 6,
